"""ClawLock v2.3.1 report renderer - Rich terminal + JSON + HTML output."""
...
def render_scan_report(
    ...
    findings_summary = [
        {"title": f.title, "level": f.level, "location": f.location}
        for f in all_f
...
def _render_html(
    ...
    _footer1 = t("由 ClawLock v2.3.1 生成", "Generated by ClawLock v2.3.1")
