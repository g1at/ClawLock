"""ClawLock v1.2.0 report renderer - Rich terminal + JSON + HTML output."""
...
def render_scan_report(
    ...
    console.print(
        Panel(
            "[dim]Generated by ClawLock v1.2.0. Static analysis reflects the currently visible code and config only.[/dim]",
            border_style="dim",
        )
    )
...
<div class="footer">Generated by ClawLock v1.2.0 | <a href="https://github.com/g1at/clawlock">github.com/g1at/clawlock</a><br>
